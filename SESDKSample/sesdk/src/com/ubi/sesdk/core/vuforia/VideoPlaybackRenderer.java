...
import com.ubi.sesdk.core.utils.KeyFrameShaders;
import com.ubi.sesdk.core.utils.SampleMath;
import com.ubi.sesdk.core.utils.SampleUtils;
...
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer {
    ...
    VuforiaVideoManager vuforiaVideoManager;
    ...
    public VideoPlaybackRenderer(VideoPlayback activity, VuforiaVideoManager vuforiaVideoManager) {
        this.mActivity = activity;
        this.vuforiaVideoManager = vuforiaVideoManager;
    ...
    void initRendering(){
        ...
        for(int i = 0; i < VideoPlayback.NUM_TARGETS; i++){
            keyframeQuadAspectRatio[i] = (float) mTextures.get(i).mHeight / (float) mTextures.get(i).mWidth;
        }
    ...
    void renderFrame(){
        ...
        // Set the viewport
        int[] viewport = vuforiaVideoManager.getViewport();
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++){
            ...
            int currentTarget = vuforiaVideoManager.getKeyVideo(imageTarget.getName());
                ...
                || (currentStatus[currentTarget] == VideoPlayerHelper.MEDIA_STATE.ERROR))
            {
                ...
                Matrix.multiplyMM(modelViewProjectionKeyframe, 0,
                        vuforiaVideoManager.getProjectionMatrix().getData(), 0,
    ...
    boolean isTapOnScreenInsideTarget(int target, float x, float y){
        ...
        intersection = SampleMath.getPointToPlaneIntersection(SampleMath
                        .Matrix44FInverse(vuforiaVideoManager.getProjectionMatrix()),
